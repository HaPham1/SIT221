...
namespace Vector
{
    class Tester
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                Console.WriteLine("\nTest I: Print the content of the empty vector via calling vector.ToString();");
                Console.WriteLine(vector.ToString());
                Console.WriteLine(" :: SUCCESS");
                result = result + "K";
            }
            ...
            try
            {
                Console.WriteLine("\nTest B: Add a sequence of numbers 2, 6 Then Insert in Out Of Range Index");
                vector.Add(2); vector.Add(6);
                vector.Insert(6, 50);
                Console.WriteLine(" :: FAIL");
                result = result + "-";
            }
            ...
            try
            {
                Console.WriteLine("\nTest J: Clear the content of the vector then check Count = 0");
                vector.Clear();
                if (vector.Count != 0) throw new Exception("Count is not 0");
                Console.WriteLine(" :: SUCCESS");
                result = result + "M";
            }
            catch (Exception exception)
