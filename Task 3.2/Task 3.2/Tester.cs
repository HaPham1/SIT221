...
namespace Vector
{
    ...
    class Tester
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                Console.WriteLine("\nTest Extra: Sort 2 integers applying RandomizedQuickSort with AscendingIntComparer: ");
                vector = new Vector<int>(problem_size);
                vector.Sorter = new RandomizedQuickSort();
                for (int i = 0; i < 2; i++) vector.Add(data[i]);
                Console.WriteLine("Intital data: " + vector.ToString());
                vector.Sort(new AscendingIntComparer());
                Console.WriteLine("Resulting order: " + vector.ToString());
                if (!CheckAscending(vector)) throw new Exception("Sorted vector has an incorrect sequence of integers");
            ...
            try
            {
                Console.WriteLine("\nTest Extra: Sort 3 integers applying RandomizedQuickSort with AscendingIntComparer: ");
                vector = new Vector<int>(problem_size);
                vector.Sorter = new RandomizedQuickSort();
                for (int i = 0; i < 3; i++) vector.Add(data[i]);
                Console.WriteLine("Intital data: " + vector.ToString());
                vector.Sort(new AscendingIntComparer());
                Console.WriteLine("Resulting order: " + vector.ToString());
                if (!CheckAscending(vector)) throw new Exception("Sorted vector has an incorrect sequence of integers");
            ...
            try
            {
                Console.WriteLine("\nTest Extra 2: Sort 1 integer applying MergeSortTopDown with AscendingIntComparer: ");
                vector = new Vector<int>(problem_size);
                vector.Sorter = new MergeSortTopDown();
                for (int i = 0; i < 1; i++) vector.Add(data[i]);
                Console.WriteLine("Intital data: " + vector.ToString());
                vector.Sort(new AscendingIntComparer());
                Console.WriteLine("Resulting order: " + vector.ToString());
                if (!CheckAscending(vector)) throw new Exception("Sorted vector has an incorrect sequence of integers");
            ...
            try
            {
                Console.WriteLine("\nTest Extra 2: Sort 2 integer applying MergeSortTopDown with AscendingIntComparer: ");
                vector = new Vector<int>(problem_size);
                vector.Sorter = new MergeSortTopDown();
                for (int i = 0; i < 2; i++) vector.Add(data[i]);
                Console.WriteLine("Intital data: " + vector.ToString());
            ...
            try
            {
                Console.WriteLine("\nTest Z: Sort 1 integer applying MergeSortBottomUp with AscendingIntComparer: ");
                vector = new Vector<int>(problem_size);
                vector.Sorter = new MergeSortBottomUp();
                for (int i = 0; i < 1; i++) vector.Add(data[i]);
                Console.WriteLine("Intital data: " + vector.ToString());
            ...
            try
            {
                Console.WriteLine("\nTest Z: Sort 2 integer applying MergeSortBottomUp with AscendingIntComparer: ");
                vector = new Vector<int>(problem_size);
                vector.Sorter = new MergeSortBottomUp();
                for (int i = 0; i < 2; i++) vector.Add(data[i]);
                Console.WriteLine("Intital data: " + vector.ToString());
